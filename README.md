...
- 🐱 **[MeowMed](https://mormeow.com)** `private` – Comprehensive cat health knowledge hub with 826+ vet articles across 21 categories, AI diagnostic chatbot, faceted search, life-stage guides, and hospital directory — built with Next.js 16, React 19, and Google AI SDK by a licensed DVM
...
- 🏥 **[lbc-clinic-web](https://github.com/mingrath/lbc-clinic-web)** – Modern veterinary clinic website with appointment booking and service showcase — built with Next.js and TypeScript
...
- 🏢 **Web Agency** `private` – Web agency portfolio with GSAP scroll animations, particle effects, and email integration — built with Astro 5, React 19, and Tailwind CSS 4
